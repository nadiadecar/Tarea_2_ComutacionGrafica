...
def Fondo(fondoE): 
	color = es.toGPUShape(bs.createTextureCube("fondo1.png"),GL_REPEAT, GL_NEAREST)
...
if __name__ == "__main__":
	...
	while not glfw.window_should_close(window):
		...
		tapaAnt = tc.TapaCursoNorm(cursoAnterior.codigo)
		...
		for requisitoAnt in cursoAnterior.requisitos:
			...
			tapaReqAnt = tc.TapaCursoNorm(requisitoAnt)
		...
		for requisitoDeAnt in cursoAnterior.requisitosDe:
			...
			tapaReqDeAnt = tc.TapaCursoNorm(requisitoDeAnt)
		...
		tapaAct = tc.TapaCursoSelec(cursoActual.codigo)
		...
		for requisito in cursoActual.requisitos:
			...
			tapaReq = tc.TapaCursoSelec(requisito)
		...
		for requisitoDe in cursoActual.requisitosDe:
			...
			tapaReqDe = tc.TapaCursoSelec(requisitoDe)
