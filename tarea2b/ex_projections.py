...
if __name__ == "__main__":
    ...
    textPipe = es.SimpleTextureModelViewProjectionShaderProgram()
    ...
    gpuGreenCube = es.toGPUShape(bs.createTextureCube("dice_blue.jpg"), GL_REPEAT, GL_NEAREST)
    ...
    while not glfw.window_should_close(window):
        ...
        glUniformMatrix4fv(glGetUniformLocation(textPipe.shaderProgram, "view"), 1, GL_TRUE, view)
        ...
        glUniformMatrix4fv(glGetUniformLocation(textPipe.shaderProgram, "projection"), 1, GL_TRUE, projection)
        ...
        glUniformMatrix4fv(glGetUniformLocation(textPipe.shaderProgram, "model"), 1, GL_TRUE, tr.translate(-5,0,0))
